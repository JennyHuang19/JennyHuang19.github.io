...
ethicist and cognitive scientist josh may offers a helpful rule of thumb for thinking about how to use ai for [intellectual tasks](https://joshdmay.substack.com/p/why-smart-people-make-weak-arguments): “you should use llms to generate inputs to your thinking, not outputs for others to read.”
...
<figure style="text-align: center;">
  ...
  <figcaption style="font-size: 1.05em;">figure 2. a real-world example of gpt-5.2 reusing outdated information in chat history. in a previous query, the user requested umap clustering code. in the next turn, the user says, "use t-sne instead." left: when the previous assistant response remains in context, the model incorrectly carries over the jaccard metric from umap into the t-sne implementation. right: without the previous response in context, the model generates correct t-sne code with appropriate arguments.</figcaption>
</figure>

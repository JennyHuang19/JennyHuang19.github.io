...
<img src="/images/post-figures/conceptual-multiverse.jpeg" alt="figure 1. with the conceptual multiverse interface, we represent conceptual forks-in-the-road as a sequence of states, connected by transformations that advance towards an llm's final response." width="50%" style="display: block; margin: 0 auto;" />
...
<img src="/images/post-figures/cartoon_v3.png" alt="figure 2. a real-world example of gpt-5.2 reusing outdated information in chat history. in a previous query, the user requested umap clustering code. in the next turn, the user says, use t-sne instead. left: when the previous assistant response remains in context, the model incorrectly carries over the jaccard metric from umap into the t-sne implementation. right: without the previous response in context, the model generates correct t-sne code with appropriate arguments." width="30%" style="display: block; margin: 0 auto;" />

...
![figure 1. with the conceptual multiverse interface, we represent conceptual forks-in-the-road as a sequence of states, connected by transformations that advance towards an llm's final response.](/images/post-figures/cartoon_v3.png)
